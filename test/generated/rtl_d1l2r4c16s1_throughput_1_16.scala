...
@spatial class rtl_d1l2r4c16s1_throughput_1_16(lattice_loops: Int, pwl_iterations: Int) extends SpatialTest {
...
//    val intermediate_DRAM = DRAM[T](I32(iterations))
    ...
    Accel {
      ...
      Pipe {
        ...
        val result = rtl_d1l2r4c16s1_throughput_1_16_callable.rtl_d1l2r4c16s1_throughput_1_16_callable(sram_0, sram_1, sram_2, sram_3, sram_4, sram_5, sram_6, sram_7, sram_8)
...
class rtl_d1l2r4c16s1_throughput_1_16_funroll extends rtl_d1l2r4c16s1_throughput_1_16(0, 1)
