...
@spatial class rtl_d1l2r4c16s1_h5(lattice_loops: Int, pwl_iterations: Int) extends SpatialTest {
  ...
  def main(args: Array[String]) : Unit = {
    ...
    Accel {
      ...
      val result = rtl_d1l2r4c16s1_h5_callable.rtl_d1l2r4c16s1_h5_callable(sram_0, sram_1, sram_2, sram_3, sram_4, sram_5, sram_6, sram_7, sram_8)
    ...
    Range(0, iterations) foreach {
      iter =>
        val diff = golden(I32(iter)) - received(I32(iter))
        println(r"Iter: $iter, Diff: $diff")
    }
...
class rtl_d1l2r4c16s1_h5_funroll extends rtl_d1l2r4c16s1_h5(0, 1)
