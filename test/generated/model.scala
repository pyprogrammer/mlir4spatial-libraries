...
//  import spatial.dsl._
//
//  override def compileArgs: Args = super.compileArgs and "--noModifyStream --noBindParallels"
//
//  type T = FixPt[TRUE, _4, _12]
//  val iterations = 10
//  implicit val cfg = mlir_libraries.OptimizationConfig(lattice_loops = lattice_loops, pwl_iterations = pwl_iterations)
...
//          model_callable.model_callable_lazy(sram_0, sram_1, sram_2, sram_3, sram_4)
//      } {
//        result =>
//          Pipe.Foreach(iterations by 1) { i =>
//            output_sram(i) = result(i, I32(0))()
//          }
//      }
//
//      output_DRAM store output_sram
...
//}
//
//class model_coproc extends model_lazy(3, 1)
//
//class model_regular extends model(3, 1)
//
