...
@spatial class rtl_d1l2r4c16s1_throughput_1_16_erroring(lattice_loops: Int, pwl_iterations: Int) extends SpatialTest {
  ...
  def main(args: Array[String]) : Unit = {
    ...
    val input_0 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_0.csv")
    val sliced_input_0 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_0(row, col)}
    setMem(dram_0, sliced_input_0)
    val input_1 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_1.csv")
    val sliced_input_1 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_1(row, col)}
    setMem(dram_1, sliced_input_1)
    val input_2 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_2.csv")
    val sliced_input_2 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_2(row, col)}
    setMem(dram_2, sliced_input_2)
    val input_3 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_3.csv")
    val sliced_input_3 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_3(row, col)}
    setMem(dram_3, sliced_input_3)
    val input_4 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_4.csv")
    val sliced_input_4 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_4(row, col)}
    setMem(dram_4, sliced_input_4)
    val input_5 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_5.csv")
    val sliced_input_5 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_5(row, col)}
    setMem(dram_5, sliced_input_5)
    val input_6 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_6.csv")
    val sliced_input_6 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_6(row, col)}
    setMem(dram_6, sliced_input_6)
    val input_7 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_7.csv")
    val sliced_input_7 = Matrix.tabulate(I32(iterations), I32(1)) {case (row, col) => input_7(row, col)}
    setMem(dram_7, sliced_input_7)
    val input_8 = loadCSV2D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/input_8.csv")
...
//    val intermediate_DRAM = DRAM[T](I32(iterations))
    ...
    Accel {
      ...
      Pipe {
        ...
        val result = rtl_d1l2r4c16s1_throughput_1_16_callable_erroring.rtl_d1l2r4c16s1_throughput_1_16_callable(sram_0, sram_1, sram_2, sram_3, sram_4, sram_5, sram_6, sram_7, sram_8)
        Pipe.Foreach(I32(iterations) by I32(1)) { i =>
          output_sram(i) = result(Seq(i, I32(0)), Set(Bit(true)))()
        }
    ...
    val golden = loadCSV1D[T]("/local/ssd/home/stanfurd/local-remote-deploy/mlir4spatial-libraries/test/generated/rtl_d1l2r4c16s1/output.csv", ",")

    val received = getMem(output_DRAM)

    Foreach(I32(iterations) by 1) {
      iter =>
        val diff = abs(golden(iter) - received(iter))
        println(r"$iter: $diff")
...
class rtl_d1l2r4c16s1_throughput_1_16_funroll_erroring extends rtl_d1l2r4c16s1_throughput_1_16_erroring(0, 1)
